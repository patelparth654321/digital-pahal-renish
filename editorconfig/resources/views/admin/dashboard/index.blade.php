    ...
    <div class="mt-4 overflow-hidden bg-white border border-gray-200 rounded-lg shadow-sm">
        <div class="px-4 py-4 sm:px-6">
            <div class="flex items-center justify-between gap-4 sm:gap-6">
                ...
                <a href="{{ route('accountants') }}" title="View All Accountants" class="btn-link">
                    View All
        ...
        @if($latest_accoutants && count($latest_accoutants) > 0)
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($latest_accoutants as $row)
                        <tr>
                            ...
                            <td class="relative py-4 pl-3 pr-4 whitespace-nowrap sm:pr-6">
                                <div class="flex items-center gap-4">
                                    <a href="{{ route('view_accountant', ['id'=>$row['accountant_id']]) }}" title="" class="btn btn-icon btn-secondary-light btn-icon-transparent" aria-label="View Accountant" data-microtip-position="top" role="tooltip">
                                        <span class="sr-only">
                                            View Accountant
                                        </span>
