...
<div class="flex flex-col w-full bg-white md:max-w-xs 2xl:max-w-sm shrink-0">
    <div class="flex-1 overflow-y-auto">
        <ul class="divide-y divide-gray-200">
            @foreach($accountants as $c)
            <li class="flex items-center gap-3 p-4 sm:px-6">
                <input type="checkbox" class="form-options checkbox select_client" value="{{ $c['accountant_id'] }}">
...
@include('admin.accountants.notification_modal')
