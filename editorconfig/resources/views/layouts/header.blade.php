    ...
    <header class="sticky inset-x-0 top-0 z-20 py-3 shadow-sm bg-white/80 backdrop-blur-lg">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="flex items-center justify-between">
          <div class="shrink-0">
            <a href="{{route('landing_page')}}" title="{{ env('APP_NAME')}}"
          ...
          <div class="relative z-10">
            <a href="{{ route('inquiry') }}" title="" class="btn btn-sm btn-primary" role="button">
              Get Started Today
            </a>
            <a href="{{ route('login') }}" title="" class="btn btn-sm btn-primary" role="button">
              Login
            </a>
          </div>
        </div>
