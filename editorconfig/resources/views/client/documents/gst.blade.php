...
<section class="flex-1 py-6 overflow-y-auto">
    <div class="min-h-full px-4 sm:px-6">
        <a href="{{ route('view_member', ['id' => $data['id']]) }}" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-500 transition-all duration-150 hover:underline leading-6" title="Back">
...
<script>
    ...
    $(document).on('change', '#month_search', function(e) {
        let url = "{{ route('gst')}}?client_id={{$_GET['client_id']}}";
