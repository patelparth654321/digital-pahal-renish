                    ...
                    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                        ...
                        <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                            <div class="sm:col-span-2 input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="{{ auth()->user()->client->company_name}}" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2 input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="{{ auth()->user()->client->address}}" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="{{ auth()->user()->client->gst_number}}" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="{{ auth()->user()->client->pancard_number}}" class="form-input" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
