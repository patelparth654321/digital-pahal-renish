        ...
        <div class="pb-6 tab-content" id="myTabContent">
            <div class="hidden transition-opacity duration-150 ease-linear bg-transparent opacity-0 tab-pane show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="mt-6 space-y-8 lg:mt-8">
                    ...
                    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                        ...
                        <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="tel" value="{{ auth()->user()->phone}}" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="tel" value="{{ auth()->user()->accountant->alternate_number}}" class="form-input" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                        ...
                        <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="{{ auth()->user()->accountant->company_name}}" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="{{ auth()->user()->accountant->gst_number}}" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2 input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="{{ auth()->user()->accountant->address}}" class="form-input" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <hr class="border-gray-200">
                    <form action="{{ route('accountant_update_profile') }}" method="POST">
                        @csrf
                    ...
                    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                        ...
                        <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="email" value="{{ auth()->user()->accountant->support_email_id}}" class="form-input" required name="support_email_id">
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="tel" value="{{ auth()->user()->accountant->support_phone}}" class="form-input" required name="support_phone">
                                </div>
                            </div>
                            <div class="sm:col-span-2 input-group">
            ...
            <div class="hidden transition-opacity duration-150 ease-linear bg-transparent opacity-0 tab-pane" id="password" role="tabpanel" aria-labelledby="password-tab">
                <form action="{{ route('accountant_update_password') }}" method="POST">
                    @csrf
                    <div class="space-y-8">
                        <!-- START PASSWORD -->
                        <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
