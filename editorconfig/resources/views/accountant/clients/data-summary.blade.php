...
<section class="flex-1 py-6 overflow-y-auto">
    <div class="min-h-full px-4 sm:px-6">
        ...
        <a href="{{ $parent_id =='' ? route('view_client', ['id'=>$user->id]) : route('view_client_member', ['id'=>$user->id, 'parentid'=>$parent_id]) }}" title="Back" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-500 transition-all duration-150 hover:underline leading-6">
        ...
        <div class="flex flex-col gap-4 mt-4 sm:gap-6 md:justify-between md:flex-row md:items-center">
            ...
            <div class="flex flex-col gap-4 xl:justify-end sm:flex-row sm:items-center">
                <a href="{{ $parent_id =='' ? route('accoutant_gst', ['client_id'=>$user->id]) : route('accoutant_gst', ['client_id'=>$user->id, 'parentid'=>$parent_id]) }}" title="Import Data" class="w-full btn btn-primary-light sm:w-auto" role="button" data-toggle="modal" data-target="#bulkClientsModal">
                    <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div class="flex-1 xl:flex-none">
                    ...
                    <div>
                        <select name="" id="month_search" class="pl-3 pr-10 form-select">
                            ...
                            <option {{ (isset($_GET['month']) && $_GET['month']==$key) ? "selected" : ( !(isset($_GET['month'])) && $key == date('m') ? "selected":"")  }} value="{{$key}}">
                                {{$value}}
                            </option>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 list">
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ round($b2b['taxable_amount'], 2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ round($b2b['integrated_tax'], 2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ round($b2b['central_tax'], 2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{$b2b['state_tax']}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ round($b2b['cess_amount'], 2)}}
                            </td>
                            <td class="py-4 pl-3 pr-4 text-sm text-gray-900 whitespace-nowrap sm:pr-6">
                                {{ round($b2b['invoice_amount'],2)}}
                            </td>
                        </tr>
                        @if($user->gst_type == 1 || ($user->gst_type == 2 && isset($_GET['month']) && in_array($_GET['month'], ["06", "09", "12", "03"])))
                        <tr>
                            <td class="py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 whitespace-nowrap">
                                2
                            </td>
                            ...
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{ round($b2c_large['taxable_amount'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c_large['integrated_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c_large['central_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c_large['state_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c_large['cess_amount'],2)}}
                            </td>
                            <td class="py-4 pl-3 pr-4 text-sm text-gray-900 whitespace-nowrap sm:pr-6">
                                {{round($b2c_large['invoice_amount'],2)}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c['taxable_amount'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c['integrated_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c['central_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c['state_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($b2c['cess_amount'],2)}}
                            </td>
                            <td class="py-4 pl-3 pr-4 text-sm text-gray-900 whitespace-nowrap sm:pr-6">
                                {{round(($b2c['taxable_amount'] + $b2c['integrated_tax'] + $b2c['state_tax'] + $b2c['central_tax']),2)}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{$credit_notes['voucher']}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($credit_notes['taxable_amount'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($credit_notes['integrated_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($credit_notes['central_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($credit_notes['state_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($credit_notes['cess_amount'],2)}}
                            </td>
                            <td class="py-4 pl-3 pr-4 text-sm text-gray-900 whitespace-nowrap sm:pr-6">
                                {{round(($credit_notes['taxable_amount'] + $credit_notes['integrated_tax'] + $credit_notes['state_tax'] + $credit_notes['central_tax']),2)}}
                            </td>
                        </tr>
                        @endif
                        ...
                        <tr class="bg-gray-50">
                            ...
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($total_amount['taxable_amount'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($total_amount['integrated_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($total_amount['central_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($total_amount['state_tax'],2)}}
                            </td>
                            <td class="px-3 py-4 text-sm text-gray-900 whitespace-nowrap">
                                {{round($total_amount['cess_amount'],2)}}
                            </td>
                            <td class="py-4 pl-3 pr-4 text-sm text-gray-900 whitespace-nowrap sm:pr-6">
                                {{round(($total_amount['invoice_amount']),2)}}
                            </td>
                        </tr>
...
<script>
    ...
    $('.select2').on('select2:select', function(e) {
        ...
        let url = "{{ route('accoutant_data_summary', ['id'=>':id']) }}";
        url = url.replace(':id', data.id);
        window.location.href = url;
    });
    $(document).on('change', '#month_search', function(e) {
        let url = "{{ route('accoutant_data_summary', ['id'=>$user['id'], 'parentid'=>(isset($_GET['parentid'])? $_GET['parentid'] : '')]) }}";
        url = url + "&month=" + $(this).val().trim();
        window.location.href = url;
    })

    function downloadCsv() {
        let url = "{{ route('downloadZip', ['id'=>$user->id,'gst_type'=>$user->gst_type,'month'=>(isset($_GET['month']) ? $_GET['month'] : '')]) }}";
    ...
    function downloadJson() {
        let url = "{{ route('downloadJson', ['id'=>$user->id,'gst_type'=>$user->gst_type,'month'=>(isset($_GET['month']) ? $_GET['month'] : '')]) }}";
        if ($('#includeHsn').is(":checked")) {
            url = url + "&is_hsn=1";
        }
        url = url.replace(/&amp;/g, '&');
