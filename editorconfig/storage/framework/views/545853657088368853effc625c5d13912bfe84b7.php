...
<section class="flex-1 py-6 overflow-y-auto">
  <div class="min-h-full px-4 sm:px-6">
    <a href="<?php echo e(route('view_member', ['id'=>$data['client_id']])); ?>" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-500 transition-all duration-150 hover:underline leading-6" title="Back">
          ...
          <div class="grid grid-cols-1 gap-6 mt-5 sm:grid-cols-5">
            ...
            <div class="flex items-start gap-3 sm:col-span-3">
              ...
              <div>
                ...
                <div class="flex items-center gap-2 mt-2">
                  <?php echo getUserCategoryType($data['type']); ?>
            ...
            <div class="flex items-start gap-3 sm:col-span-2">
              ...
              <div>
                ...
                <p class="mt-2 text-base font-medium text-gray-900">
                  <?php echo dateFormat($data['created_at'], 'd M Y'); ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/client/members/details.blade.php ENDPATH**/ ?>