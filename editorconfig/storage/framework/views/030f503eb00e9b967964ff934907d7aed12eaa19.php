...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('plugins/quill/quill.snow.css')); ?>">
  <!-- CUSTOM CSS -->
  <link rel="stylesheet" href="<?php echo e(asset('css/main.css')); ?>">
  <script src="<?php echo e(asset('plugins/jquery-3.4.1.min.js')); ?>"></script>
  <!-- PAGE TITLE -->
  <title>
  <?php echo $__env->yieldContent('title', 'Dashboard'); ?> / Admin / <?php echo e(env('APP_NAME')); ?>
...
<script>
  ...
  var config = {
    route: "<?php echo e(route('dashboard')); ?>"
  };
</script>
...
</html><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/layouts/master.blade.php ENDPATH**/ ?>