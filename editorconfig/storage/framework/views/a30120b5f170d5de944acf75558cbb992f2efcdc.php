        ...
        <div class="flex flex-col gap-4 xl:justify-end sm:flex-row sm:items-center">
            <div class="flex-1 w-full xl:max-w-xs">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="searchKeyword" placeholder="Search by member name, company, phone or email..." value="<?php echo e(isset($_GET['search']) ? $_GET['search']: ''); ?>" class="pl-10 form-input">
                </div>
            </div>

            <div class="flex items-center gap-4">
                <a href="<?php echo e(route('add_member')); ?>" title="Add Member" class="w-full btn btn-primary sm:w-auto" role="button">
    ...
    <div id="clientsView">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 list">
                        ...
                        <tr>
                            ...
                            <a href="<?php echo e(route('view_member', ['id'=>$row['client_id']])); ?>" >
                            ...
                            <td class="relative py-4 pl-3 pr-4 whitespace-nowrap sm:pr-6">
                                <div class="flex items-center gap-4">
                                    ...
                                    <a href="<?php echo e(route('view_member', ['id'=>$row['client_id']])); ?>" title="" class="btn btn-icon btn-secondary-light btn-icon-transparent">
                                        <span class="sr-only">
                                            View Member
                                        </span>
                                        <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="flex items-center justify-center h-full p-12 text-center sm:p-16 sm:max-w-md sm:mx-auto">
            <div>
                ...
                <div class="mt-6">
                    <a href="<?php echo e(route('add_member')); ?>" title="Add Member" class="btn btn-primary" role="button">
                        <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                            <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path>
                            <path d="M16 19h6"></path>
...
<script>
    $(document).on('keypress', "#searchKeyword", function() {
        ...
        if (keycode == '13') {
            let url = "<?php echo e(route('members')); ?>?search=" + $(this).val().trim();
    ...
    $(document).on('change', '#status', function(e) {
        let url = "<?php echo e(route('members')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/client/members/index.blade.php ENDPATH**/ ?>