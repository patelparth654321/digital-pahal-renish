    ...
    <div class="flex-1 overflow-y-auto">
        <ul class="divide-y divide-gray-200">
            ...
            <li class="flex items-center gap-3 p-4 sm:px-6">
                <input type="checkbox" class="form-options checkbox select_client" value="<?php echo e($c['client_id']); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('accountant.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/accountant/clients/notifications.blade.php ENDPATH**/ ?>