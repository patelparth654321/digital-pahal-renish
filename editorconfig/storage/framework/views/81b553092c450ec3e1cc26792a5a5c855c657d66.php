<body class="h-full font-sans antialiased text-gray-900 bg-white lg:overflow-hidden">
  ...
  <div class="relative flex flex-1 lg:h-screen">
    ...
    <aside class="bg-white w-[280px] shrink-0 overflow-y-auto space-y-4 hidden lg:flex">
      <div class="w-full px-4 py-6 space-y-6 lg:flex lg:flex-col">
        <div class="flex items-center gap-3 px-3">
          <a href="<?php echo e(route('landing_page')); ?>" title="DigitalPahal" class="flex">
            <img class="w-auto h-8" src="<?php echo e(asset('images/logo.svg')); ?>" alt="DigitalPahal">
          </a>
        ...
        <div class="bg-white border border-gray-200 divide-y divide-gray-200 rounded-lg">
          ...
          <a href="<?php echo e(route('client_dashboard')); ?>">
            <div class="flex items-center gap-3">
              <img class="object-cover w-8 h-8 bg-gray-300 rounded-lg shrink-0" src="<?php echo e(getImagePath(getAccountantDetail(auth()->user()->added_by)->logo, 'accountant/logo')); ?>" alt="">
              <p class="flex-1 min-w-0 text-sm font-semibold text-gray-900 truncate">
                <?php echo e(getAccountantDetail(auth()->user()->added_by)->company_name); ?>
          ...
          <div class="p-3">
          <a href="<?php echo e(route('view_member', ['id'=>auth()->user()->id])); ?>">
            <div class="flex items-center gap-3">
              <div class="avatar avatar-default">
                <?php echo e(getNameShort(auth()->user()->name)); ?>
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="mt-px text-xs font-normal text-gray-500 truncate">
                  <?php echo e(auth()->user()->client->company_name); ?>
        ...
        <div class="flex-1 space-y-1">
          <a href="<?php echo e(route('members', ['type'=>'2'])); ?>" title="GST Documents" class="nav-link <?php echo e((\Request::route()->getName() == 'members') && (isset($_GET['type']) && $_GET['type']=='2') ? 'active' : ''); ?>">
            ...
            <!-- <span class="ml-auto badge badge-default-light">
              <?php echo e(getClientCount(auth()->user()->id, 2)); ?>

            </span> -->
          </a>

          <a href="<?php echo e(route('members', ['type'=>'1'])); ?>" title="DMS Documents" class="nav-link <?php echo e((\Request::route()->getName() == 'members') && (isset($_GET['type']) && $_GET['type']=='1') ? 'active' : ''); ?>">
            ...
            DMS Members
            <!-- <span class="ml-auto badge badge-default-light">
              <?php echo e(getClientCount(auth()->user()->id, 1)); ?>

            </span> -->
          </a>
          <a href="<?php echo e(route('members')); ?>" title="Members" class="nav-link <?php echo e((\Request::route()->getName() == 'members') && (!isset($_GET['type']) || (isset($_GET['type']) && $_GET['type']='1,2')) ? 'active' : ''); ?>">
            <svg aria-hidden="true" class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="space-y-1">
          ...
          <!-- <a href="<?php echo e(route('client_help')); ?>" title="Help & Support" class="nav-link">
            <svg aria-hidden="true" class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
          ...
          <a href="<?php echo e(route('client_profile')); ?>" title="Account & Settings" class="nav-link <?php echo e((\Request::route()->getName() == 'client_profile') ? 'active' : ''); ?>">
            <svg aria-hidden="true" class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    ...
    <main class="flex-1 min-w-0 bg-white lg:flex lg:flex-col lg:border-l lg:border-gray-200">
                      ...
                      <div class="px-4 py-5" role="none">
                        ...
                        <ul class="mt-4 space-y-3 text-sm font-medium text-gray-900">
                          <li class="flex items-center gap-3">
                            ...
                            <?php echo e(getAccountantDetail(auth()->user()->added_by)->support_email_id); ?>
                          ...
                          <li class="flex items-center gap-3">
                            ...
                            <?php echo e(getAccountantDetail(auth()->user()->added_by)->support_phone); ?>
              ...
              <div class="relative flex dropdown">
                ...
                <div class="absolute right-0 z-30 invisible mt-1 overflow-hidden transition-all duration-100 origin-top-right scale-95 bg-white rounded-lg shadow-lg opacity-0 pointer-events-none w-80 sm:w-96 top-full ring-1 ring-gray-200 focus:outline-none dropdown-menu" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
                  <div class="divide-y divide-gray-100">
                    ...
                    <a href="<?php echo e(route('client_notifications')); ?>" class="flex items-center justify-center px-4 py-2.5 transition-all duration-150 bg-gray-50 hover:bg-gray-100 text-gray-500 hover:text-gray-900 gap-1.5 text-sm font-medium">
                      View All
                      <svg aria-hidden="true" class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                        <path d="M5 12l14 0"></path>
      ...
      <!-- END HEADER --><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/client/layouts/header.blade.php ENDPATH**/ ?>