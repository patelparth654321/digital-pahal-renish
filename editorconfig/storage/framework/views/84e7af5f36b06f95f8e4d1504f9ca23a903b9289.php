...
<div class="min-h-full px-4 sm:px-6">
    <form method="POST" action="<?php echo e(route('admin_update_profile')); ?>">
        <div class="space-y-8">
                ...
                <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                    <div class="sm:col-span-2 input-group">
                        ...
                        <div class="mt-1.5 input-wrapper">
                            <input type="email" name="email" value="<?php echo e(auth()->user()->email); ?>" class="form-input" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                ...
                <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                    <div class="sm:col-span-2 input-group">
                        ...
                        <div class="mt-1.5 input-wrapper">
                            <input type="url" name="payment_url" value="<?php echo e(getConfigValueByKey('payment_url')); ?>" class="form-input">
                        </div>
                    </div>
                </div>
            </div> -->
            ...
            <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                ...
                <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                    <div class="input-group">
                        ...
                        <div class="mt-1.5 input-wrapper">
                            <input type="email" name="app_email" value="<?php echo e(getConfigValueByKey('app_email')); ?>" class="form-input">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="mt-1.5 input-wrapper">
                            <input type="tel" name="app_phone" value="<?php echo e(getConfigValueByKey('app_phone')); ?>" class="form-input">
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/profile.blade.php ENDPATH**/ ?>