    ...
    <div class="flex flex-col gap-4 xl:justify-end sm:flex-row sm:items-center">
      <div class="flex-1 w-full xl:max-w-xs">
        ...
        <div class="relative">
          ...
          <input type="search" id="searchKeyword" placeholder="Search by accountant name, phone or company..." value="<?php echo e(isset($_GET['search']) ? $_GET['search']: ''); ?>" class="pl-10 form-input">
        </div>
      </div>

      <div class="flex items-center gap-4">
        <a href="<?php echo e(route('add_accountant')); ?>" title="Add Accountant" class="w-full btn btn-primary sm:w-auto" role="button">
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200 list">
            ...
            <tr>
              ...
              <a href="<?php echo e(route('view_accountant', ['id'=>$row['id']])); ?>">
              ...
              <td class="relative py-4 pl-3 pr-4 whitespace-nowrap sm:pr-6">
                <div class="flex items-center gap-4">
                  <a href="<?php echo e(route('view_accountant', ['id'=>$row['id']])); ?>" title="" class="btn btn-icon btn-secondary-light btn-icon-transparent" aria-label="View Accountant" data-microtip-position="top" role="tooltip">
                    <span class="sr-only">
                      View Accountant
                    </span>
                    <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/accountants/index.blade.php ENDPATH**/ ?>