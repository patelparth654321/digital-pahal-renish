...
<section class="flex-1 py-6 overflow-y-auto">
    <div class="min-h-full px-4 sm:px-6">
        ...
        <form action="<?php echo e(route('policies')); ?>" method="POST" id="submitForm" class="space-y-8">
            <?php echo csrf_field(); ?>
            ...
            <input type="hidden" id="privacy_policy" name="privacy_policy" value="<?php echo getConfigValueByKey('privacy_policy'); ?>"/>
            <input type="hidden" id="dms_policy" name="dms_policy" value="<?php echo getConfigValueByKey('dms_policy'); ?>" />
            <input type="hidden" id="gst_policy" name="gst_policy" value="<?php echo getConfigValueByKey('gst_policy'); ?>" />
            <input type="hidden" id="terms_of_service" name="terms_of_service" value="<?php echo getConfigValueByKey('terms_of_service'); ?>" />
        </form>

    </div>
</section>
<!-- END CONTENT -->
<script src="<?php echo e(asset('plugins/quill/quill.js')); ?>"></script>
<script>
    ...
    quillPrivacy.setContents(quillPrivacy.clipboard.convert("<?php echo getConfigValueByKey('privacy_policy'); ?>"), 'silent');
    ...
    quillTerm.setContents(quillTerm.clipboard.convert("<?php echo getConfigValueByKey('terms_of_service'); ?>"), 'silent');
    ...
    quillDms.setContents(quillDms.clipboard.convert("<?php echo getConfigValueByKey('dms_policy'); ?>"), 'silent');
    ...
    quillData.setContents(quillData.clipboard.convert("<?php echo getConfigValueByKey('gst_policy'); ?>"), 'silent');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/policies.blade.php ENDPATH**/ ?>