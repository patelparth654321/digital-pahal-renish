    ...
    <div class="flex flex-col gap-4 xl:justify-end sm:flex-row sm:items-center">
      <div class="flex-1 w-full xl:max-w-xs">
        ...
        <div class="relative">
          ...
          <input type="search" id="searchKeyword" placeholder="Search by name, email, phone or company..." value="<?php echo e(isset($_GET['search']) ? $_GET['search']: ''); ?>" class="pl-10 form-input">
        </div>
      </div>
            ...
            <tr>
              ...
              <td class="hidden px-3 py-4 text-sm text-gray-600 md:table-cell whitespace-nowrap">
                <div class="flex items-center gap-1.5">
                    <?php echo getUserCategoryType($row['category']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/inquiry.blade.php ENDPATH**/ ?>