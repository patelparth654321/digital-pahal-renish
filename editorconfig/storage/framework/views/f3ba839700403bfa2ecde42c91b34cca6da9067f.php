...
<section class="pb-12 bg-white border-b border-gray-200 sm:pb-16 lg:pb-20 xl:pb-24">
  <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
    <form action="<?php echo e(('inquiry')); ?>" method="POST" class="grid max-w-xl grid-cols-1 mx-auto sm:grid-cols-2 gap-x-6 gap-y-5">
      <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/inquiry.blade.php ENDPATH**/ ?>