...
<body class="h-full font-sans antialiased text-gray-900 bg-white">
      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col justify-between max-w-md mx-auto">
          <div class="flex-1 text-center lg:text-left">
            <a href="<?php echo e(route('landing_page')); ?>" title="Back to Home" class="">
              <img class="w-auto h-8 mx-auto lg:h-10 lg:mx-0" src="<?php echo e(asset('images/logo.svg')); ?>" alt="">
            </a>
          ...
          <div class="hidden lg:block">
            <img class="w-full" src="<?php echo e(asset('images/login-illustration.svg')); ?>" alt="">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-sm xl:max-w-md">
          ...
          <p class="mt-10 text-sm font-normal leading-6 text-center text-gray-600 sm:px-6">
            Signing up for a <?php echo e(env('APP_NAME')); ?> account means you agree to the <a href="#" title="" class="text-primary-600 hover:underline">Privacy Policy</a> and <a href="#" title="" class="text-primary-600 hover:underline">Terms of Service</a>.
          </p>
        </div>
      </div>
    </div>
  ...
  <!-- PLUGINS -->
  <script src="<?php echo e(asset('plugins/hide-show-password/hideShowPassword.min.js')); ?>"></script>
...
</html><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>