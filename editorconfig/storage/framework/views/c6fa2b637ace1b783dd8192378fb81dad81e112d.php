    ...
    <div class="mt-4 overflow-hidden bg-white border border-gray-200 rounded-lg shadow-sm">
        <div class="px-4 py-4 sm:px-6">
            <div class="flex items-center justify-between gap-4 sm:gap-6">
                ...
                <a href="<?php echo e(route('clients')); ?>" title="View All Clients" class="btn-link">
                    View All
...
<?php echo $__env->make('accountant.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/accountant/dashboard/index.blade.php ENDPATH**/ ?>