    ...
    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
      ...
      <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
        ...
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" class="form-input" required>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="tel" name="alternate_number" value="<?php echo e(old('alternate_number')); ?>" class="form-input">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
      ...
      <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
          ...
          <div>
            ...
            <div class="relative flex items-center gap-5 mt-2">
              <div class="flex-shrink-0 w-12 h-12 overflow-hidden rounded-lg ring-1 ring-gray-200">
                <img class="object-cover w-full h-full image_file" src="<?php echo e(asset('images/default-avatar.png')); ?>" alt="">
              </div>
        ...
        <div class="sm:col-span-2 input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="text" name="company_name" value="<?php echo e(old('company_name')); ?>" class="form-input" required>
          </div>
        </div>
        ...
        <div class="hidden input-group" id="withGstInput">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="text" name="gst_number" id="gst_number" value="<?php echo e(old('gst_number')); ?>" class="form-input">
          </div>
        </div>
        ...
        <div class="sm:col-span-2 input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="text" name="address" value="<?php echo e(old('address')); ?>" class="form-input" required>
          </div>
        </div>
    ...
    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
      ...
      <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="email" name="support_email_id" value="<?php echo e(old('support_email_id')); ?>" class="form-input" required>
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="tel" name="support_phone" value="<?php echo e(old('support_phone')); ?>" class="form-input" required>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
      ...
      <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="password" name="password" value="<?php echo e(old('password')); ?>" class="form-input" required>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
      ...
      <!-- <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="number" name="discount" max="100" min="0" value="<?php echo e(old('discount') ? old('discount') : 0.00); ?>" class="form-input">
          </div>
        </div>
      </div> -->
    </div>
...
<script>
  ...
  $(document).on('click', '.remove', function() {
    ...
    $(this).parent().find('.image_file').attr('src', "<?php echo e(asset('images/default-avatar.png')); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/accountants/add.blade.php ENDPATH**/ ?>