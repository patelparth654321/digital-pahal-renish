  ...
  <div class="relative flex flex-1 lg:h-screen">
    ...
    <aside class="bg-white w-[280px] shrink-0 overflow-y-auto space-y-4 hidden lg:flex">
      <div class="w-full px-4 py-6 space-y-6 lg:flex lg:flex-col">
        ...
        <div class="space-y-1">
          <a href="<?php echo e(route('dashboard')); ?>" title="Dashboard" class="nav-link <?php echo e((\Request::route()->getName() == 'dashboard') ? 'active' : ''); ?>">
        ...
        <div>
          ...
          <div class="mt-3 space-y-1">
            <a href="<?php echo e(route('accountants')); ?>" title="Accountants" class="nav-link <?php echo e((\Request::route()->getName() == 'accountants') ? 'active' : ''); ?>">
              <svg aria-hidden="true" class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <a href="<?php echo e(route('notifications')); ?>" title="Send Notifications" class="nav-link <?php echo e((\Request::route()->getName() == 'notifications') ? 'active' : ''); ?>">
              <svg aria-hidden="true" class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="flex-1">
          ...
          <div class="mt-3 space-y-1">
            <a href="<?php echo e(route('policies')); ?>" title="Policies" class="nav-link <?php echo e((\Request::route()->getName() == 'policies') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('contactus')); ?>" title="Contact Us" class="nav-link <?php echo e((\Request::route()->getName() == 'contactus') ? 'active' : ''); ?>">
              <svg aria-hidden="true" class="group-hover:text-gray-900" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <a href="<?php echo e(route('enquiries')); ?>" title="Inquiries" class="nav-link <?php echo e((\Request::route()->getName() == 'enquiries') ? 'active' : ''); ?>">
              <svg aria-hidden="true" class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="space-y-1">
          <a href="<?php echo e(route('admin_profile')); ?>" title="Account & Settings" class="nav-link <?php echo e((\Request::route()->getName() == 'admin_profile') ? 'active' : ''); ?>">
            <svg aria-hidden="true" class="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    ...
    <main class="flex-1 min-w-0 bg-white lg:flex lg:flex-col lg:border-l lg:border-gray-200">
      ...
      <!-- START CONTENT -->
      <section class="flex-1 py-6 overflow-y-auto"><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>