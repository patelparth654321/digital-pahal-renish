...
<section class="flex-1 py-6 overflow-y-auto">
    <div class="min-h-full px-4 sm:px-6">
        <a href="<?php echo e(route('accoutant_data_summary', ['id'=>$data['id'], 'parentid'=>(isset($_GET['parentid'])? $_GET['parentid'] : '')])); ?>" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-500 transition-all duration-150 hover:underline leading-6" title="Back">
                    ...
                    <div>
                        ...
                        <div>
                            <select name="" id="month_search" class="form-select">
                                ...
                                <option <?php echo e($isDisabled ? "disabled":""); ?> <?php echo e((isset($_GET['month']) && $_GET['month']==$key) ? "selected" : ( !(isset($_GET['month'])) && $key == date('m') ? "selected":"")); ?> value="<?php echo e($key); ?>">
                                    <?php echo e($value); ?>
...
<script>
    ...
    var config = {
        route: "<?php echo e(route('accountant_dashboard')); ?>"
    };
</script>
...
<script>
    ...
    $(document).on('change', '#month_search', function(e) {
        let url = "<?php echo e(route('accoutant_gst')); ?>?client_id=<?php echo e($_GET['client_id']); ?>&parentid=<?php echo e(isset($_GET['parentid']) ? $_GET['parentid'] : ''); ?>";
        url = url + "&month=" + $(this).val().trim();
        window.location.href = url;
    })
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('accountant.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/accountant/clients/gst.blade.php ENDPATH**/ ?>