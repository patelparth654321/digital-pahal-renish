...
<section class="flex-1 py-6 overflow-y-auto">
  ...
  <script>
    $(document).on('click', '.tab_click', function(e) {
      ...
      const nextState = {};
      const nextURL = "<?php echo e(route('admin_view_client', ['id'=>$row['client_id']])); ?>" + "?type=" + type;
      window.history.pushState(nextState, nextTitle, nextURL);
    })
    $(document).on('change', '#year', function(e) {
      let url = "<?php echo e(route('admin_view_client', ['id'=>$row['client_id']])); ?>?type=" + $('#selected_tab').val();
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/accountants/client_view.blade.php ENDPATH**/ ?>