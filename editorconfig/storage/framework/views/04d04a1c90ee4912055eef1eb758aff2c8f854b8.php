...
<?php $__env->startSection('title'); ?>
    <?php echo e("Accountant Details"); ?>

<?php $__env->stopSection(); ?>
<div class="min-h-full px-4 sm:px-6">
  <a href="<?php echo e(route('accountants')); ?>" type="button" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-500 transition-all duration-150 hover:underline leading-6" title="Back">
  ...
  <div class="flex flex-col gap-4 xl:gap-6 xl:justify-between xl:flex-row xl:items-center mt-2">
    <div class="flex flex-col items-center gap-2 sm:flex-row sm:justify-start sm:gap-3">
      <img class="w-12 h-12 bg-gray-300 rounded-lg" src="<?php echo e(getImagePath($row->logo, 'accountant/logo')); ?>" alt="">
      ...
      <div class="relative flex dropdown">
        ...
        <div class="absolute right-0 z-30 invisible w-56 mt-1 transition-all duration-100 origin-top-right scale-95 bg-white rounded-lg shadow-lg opacity-0 pointer-events-none top-full ring-1 ring-gray-200 focus:outline-none dropdown-menu" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
          <div class="divide-y divide-gray-100">
              ...
              <div class="flex items-start gap-2 px-4 py-2">
                <div class="flex-1 min-w-0">
                  <p class="text-sm font-medium text-gray-900">
                    <?php echo e($row['status'] ==1? "Disable Accountant":"Enable Accountant"); ?>

                  </p>
                </div>

                <div class="relative">
                  <input type="checkbox" <?php echo e($row['status'] ==1?'checked':''); ?> class="opacity-0 sr-only peer changeStatus" id="showFullPrompt" data-id="<?php echo e($row['accountant_id']); ?>" data-type="accountants">
            ...
            <div class="py-1" role="none">
              <a href="<?php echo e(route('edit_accountant', ['id'=>$row['accountant_id']])); ?>" title="" class="flex items-center gap-3 px-4 py-2 text-sm font-medium text-gray-700 transition-all duration-150 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 whitespace-nowrap" role="menuitem" tabindex="-1">
                <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  ...
  <ul class="flex items-center w-full mt-6 space-x-4 overflow-x-auto border-b border-gray-200 tabs" id="myTab" role="tablist">
    <li class="tab-item" role="presentation">
      <button type="button" id="clients-tab" class="tab-link active" data-toggle="tab" data-target="#clients" role="tab" aria-controls="clients" aria-selected="true">
        Clients (<?php echo e($clients_count); ?>)
      </button>
    </li>
    ...
    <div class="hidden py-6 transition-opacity duration-150 ease-linear bg-transparent opacity-0 tab-pane show" id="clients" role="tabpanel" aria-labelledby="clients-tab">
      ...
      <div id="clientsView">
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200 list">
                ...
                <tr>
                  ...
                  <a href="<?php echo e(route('admin_view_client', ['id'=>$c['client_id']])); ?>" >
                  ...
                  <td class="relative py-4 pl-3 pr-4 whitespace-nowrap sm:pr-6">
                    <div class="flex items-center gap-4">
                      ...
                      <a href="<?php echo e(route('admin_view_client', ['id'=>$c['client_id']])); ?>" title="" class="btn btn-icon btn-secondary-light btn-icon-transparent" aria-label="View Client" data-microtip-position="top" role="tooltip">
                        <span class="sr-only">
                          View Client
                        </span>
                        <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="flex flex-col items-center mt-8 sm:mt-4 sm:flex-row sm:justify-between">
          <?php echo $clients->appends($_GET)->links(); ?>
            ...
            <div class="flex flex-col gap-6 sm:justify-between sm:flex-row sm:items-center">
              ...
              <div class="sm:text-right">
                <p class="text-3xl font-bold text-gray-900">
                  <?php echo env('CURRENCY').$plan->price; ?>
...
<script>
  $(document).on('keypress', "#searchKeyword", function() {
    ...
    if (keycode == '13') {
      let url = "<?php echo e(route('view_accountant', ['id'=>$row['accountant_id']])); ?>?search=" + $(this).val().trim();
  ...
  $(document).on('change', '#status', function(e) {
    let url = "<?php echo e(route('view_accountant', ['id'=>$row['accountant_id']])); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/admin/accountants/view.blade.php ENDPATH**/ ?>