...
<button onclick="history.back()" type="button" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-500 transition-all duration-150 hover:underline leading-6" title="Back">
  ...
  <form action="<?php echo e(route('add_update_client')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
    <?php echo csrf_field(); ?>
    ...
    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
      ...
      <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
        ...
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="text" name="gst_number" value="<?php echo e(old('gst_number')); ?>" class="form-input">
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="mt-1.5 input-wrapper">
            <input type="text" name="pancard_number" value="<?php echo e(old('pancard_number')); ?>" class="form-input" required>
          </div>
        </div>
      </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('accountant.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/accountant/clients/add.blade.php ENDPATH**/ ?>