...
<section class="flex-1 py-6 overflow-y-auto">
  <div class="min-h-full px-4 sm:px-6">
    <a href="<?php echo e(route('members')); ?>" class="inline-flex items-center gap-1.5 text-sm font-semibold text-primary-600 hover:text-primary-500 transition-all duration-150 hover:underline leading-6" title="Back">
    ...
    <div class="flex flex-col gap-4 xl:gap-6 xl:justify-between xl:flex-row xl:items-center mt-3">
      ...
      <div class="flex flex-col gap-4 sm:justify-start sm:flex-row sm:items-center xl:justify-end">
        <?php if(strpos($data['type'], '2') !== false): ?>
        <a href="<?php echo e(route('gst', ['client_id'=>$data['client_id'] ])); ?>" title="View GST Details" class="w-full btn btn-primary sm:w-auto" role="button">
          View GST
        </a>
        <?php endif; ?>
        <div class="relative flex dropdown">
          ...
          <div class="absolute right-0 z-30 invisible w-56 mt-1 transition-all duration-100 origin-top-right scale-95 bg-white rounded-lg shadow-lg opacity-0 pointer-events-none top-full ring-1 ring-gray-200 focus:outline-none dropdown-menu" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
            <div class="divide-y divide-gray-100">
              ...
              <a href="<?php echo e(route('member_details', ['id'=>$data['client_id']])); ?>" title="" class="flex items-center gap-3 px-4 py-2 text-sm font-medium text-gray-700 transition-all duration-150 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 whitespace-nowrap" role="menuitem" tabindex="-1">
                  <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
              ...
              <?php if($data['client_id']!= auth()->user()->id): ?>
                <a href="<?php echo e(route('edit_member', ['id'=>$data['client_id']])); ?>" title="" class="flex items-center gap-3 px-4 py-2 text-sm font-medium text-gray-700 transition-all duration-150 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 whitespace-nowrap" role="menuitem" tabindex="-1">
                  <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path>
                    <path d="M6 21v-2a4 4 0 0 1 4 -4h3.5"></path>
                ...
                <a href="javascript:void(0)" data-id="<?php echo e($data['client_id']); ?>" data-type="members" class="flex items-center gap-3 px-4 py-2 text-sm font-medium transition-all duration-150 text-error-600 hover:bg-error-50 hover:text-error-700 focus:outline-none focus:bg-error-50 focus:text-error-700 whitespace-nowrap deleteData" data-toggle="modal" data-target="#deleteConfirmationModal">
                  <svg aria-hidden="true" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    <path d="M4 7h16"></path>
    ...
    <div class="pb-6 tab-content mt-6" id="myTabContent">
      ...
      <?php $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="hidden transition-opacity duration-150 ease-linear bg-transparent opacity-0 tab-pane <?php echo e((($key === array_key_first($docs) && !isset($_GET['type'])) || (isset($_GET['type']) && $_GET['type'] == $row['key']))? 'show': ''); ?>" id="<?php echo e($row['key']); ?>" role="tabpanel" aria-labelledby="<?php echo e($row['key']); ?>-tab">
        <!-- START DOCUMENTS LIST -->
              ...
              <div class="grid grid-cols-1 mt-4 sm:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-3">
                ...
                <div class="flex items-start gap-6 p-3 text-gray-600 rounded-md bg-gray-50 ring-1 ring-inset ring-gray-500/10">
                  ...
                  <div class="flex items-center justify-end gap-2">
                    <?php if($ud['category'] && $ud['category']=="With Pass"): ?>
                    <span class="badge badge-white">
                      <?php echo e($ud['category'].' '.(":".$ud['password'])); ?>
  ...
  <input id="client_id" value="<?php echo e($data['client_id']); ?>" type="hidden" />
  ...
  <script>
    ...
    $(document).on('click', '.tab_click', function(e) {
      ...
      const nextState = {};
      const nextURL = "<?php echo e(route('view_member', ['id'=>$data['client_id']])); ?>" + "?type=" + type;
      window.history.pushState(nextState, nextTitle, nextURL);
    })

    $(document).on('change', '#month_search', function(e) {
      let url = "<?php echo e(route('view_member', ['id'=>$data['client_id']])); ?>?type=" + $('#selected_tab').val();
      url = url + "&month=" + $(this).val().trim();
      window.location.href = url;
    })
  </script>
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/client/members/view.blade.php ENDPATH**/ ?>