    ...
    <div class="space-y-8">
      ...
      <div class="">
        <div class="flex items-center justify-between gap-6">
          ...
          <a href="<?php echo e(route('client_mark_as_read')); ?>" class="btn-link">
    ...
    <div class="flex items-center justify-center h-full p-12 text-center sm:p-16 sm:max-w-md sm:mx-auto">
      <div>
        ...
        <p class="mt-2 text-sm font-normal leading-6 text-gray-600">
          When your accountant views your documents or sends you a notification, it will show up here.
        </p>
      </div>
    </div>
    <!-- END EMPTY STATE -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/client/notifications.blade.php ENDPATH**/ ?>