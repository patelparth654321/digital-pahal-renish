...
<head>
  ...
  <!-- PAGE TITLE -->
  <title>
  <?php echo $__env->yieldContent('title', 'Dashboard'); ?> / Accountant / <?php echo e(env('APP_NAME')); ?>

  </title>

</head>
<!-- Header -->
<?php echo $__env->make('accountant.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<!-- content -->
<?php echo $__env->yieldContent('content'); ?>

<!-- footer  -->
<?php echo $__env->make('accountant.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</html><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/accountant/layouts/master.blade.php ENDPATH**/ ?>