    ...
    <div class="min-h-full px-4 sm:px-6">
        ...
        <div class="pb-6 tab-content" id="myTabContent">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-warning-800">
                                To change your personal and business details, please contact your accountant.
                            </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                        ...
                        <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                            <div class="sm:col-span-2 input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="<?php echo e(auth()->user()->client->company_name); ?>" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2 input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="<?php echo e(auth()->user()->client->address); ?>" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="<?php echo e(auth()->user()->client->gst_number); ?>" class="form-input" readonly>
                                </div>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="mt-1.5 input-wrapper">
                                    <input type="text" value="<?php echo e(auth()->user()->client->pancard_number); ?>" class="form-input" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="hidden transition-opacity duration-150 ease-linear bg-transparent opacity-0 tab-pane" id="password" role="tabpanel" aria-labelledby="password-tab">
                <form action="<?php echo e(route('client_update_password')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-8">
                        <!-- START PASSWORD -->
                        <div class="flex flex-col gap-6 md:gap-x-12 xl:gap-16 md:items-start md:flex-row">
                            ...
                            <div class="grid flex-1 max-w-3xl grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="mt-1.5 input-wrapper">
                                        <input type="password" name="new_password" minlength="8" class="form-input" required>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u239499167/domains/digitalpahal.com/public_html/resources/views/client/profile.blade.php ENDPATH**/ ?>